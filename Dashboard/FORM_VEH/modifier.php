...
if($_SERVER["REQUEST_METHOD"] === "POST" && $_FILES["image"]) {
    ...
    $vehicule->update($id, $marque, $modele, $type, $mat, $prix, $desc, $imageName, $imageData);
    header("Location: ../vehicule.php");
}

$veh_id = $vehicule->find($id);
?>
        ...
        <section class="contact">
            <div class="container">
                <div class="contact-content">
                    <h2 style="text-align: center;">Modifier un vehicule</h2>
                    <div class="form-con">
                        <form action="" method="post" enctype="multipart/form-data">
                            <div class="nom">
                                <div class="form-group">
                                    <input type="text" id="modele" name="modele" value="<?php echo $veh_id['modele'] ?>" required>
                                    <label for="modele">Modele</label>
                                </div>
                                <div class="form-group">
                                    <input type="text" id="marque" name="marque" value="<?php echo $veh_id['marque'] ?>" required>
                                    <label for="marque">Marque</label>
                                </div>
                            </div>
                            <div class="nom">
                                <div class="form-group">
                                    <input type="text" id="type" name="type" value="<?php echo $veh_id['type'] ?>" required>
                                    <label for="type">Type</label>
                                </div>
                                <div class="form-group">
                                    <input type="text" id="mat" name="mat" value="<?php echo $veh_id['immatriculation'] ?>" required>
                                    <label for="mat">Immatriculation</label>
                                </div>
                            </div>
                            <div class="nom">
                                <div class="form-group">
                                    <input type="text" id="prix" name="prix" value="<?php echo $veh_id['prix_jour'] ?>" required>
                            ...
                            <textarea name="desc" id="" placeholder="Description du vehicule"><?php echo $veh_id['description'] ?></textarea>
