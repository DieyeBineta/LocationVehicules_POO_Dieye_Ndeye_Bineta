...
if(isset($_SESSION['user_id'])){
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        if($mdp !== $cmdp){
            ...
            $user->update($client_id, $nom, $prenom, $email, $mdp);
                    ...
                    <form action="" method="post">
                        <div class="nom">
                            <div class="form-group">
                                <input type="text" id="nom" name="nom" value="<?php echo $us['nom'] ?>" required>
                                <label for="nom">Nom</label>
                            </div>
                            <div class="form-group">
                                <input type="text" id="prenom" name="prenom" value="<?php echo $us['prenom'] ?>" required>
                                <label for="prenom">Prenom</label>
                            </div>
                        </div>
            
                        <div class="form-group">
                            <input type="email" id="email" name="email" value="<?php echo $us['email'] ?>" required>
                            <label for="email">Adresse Email</label>
                        </div>
            
                        <div class="nom">
                            <div class="form-group">
                                <input type="password" id="password" name="mdp" value="<?php echo $us['mot_de_passe'] ?>" required>
