...
if(isset($_SESSION['client_id'])){
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST"){
        ...
        if($mdp !== $cmdp){
            ...
            $client->update($client_id, $nom, $prenom, $email, $mdp, $tel, $adr);
                    ...
                    <form action="" method="post">
                        <div class="nom">
                            <div class="form-group">
                                <input type="text" id="nom" name="nom" value="<?php echo $cl['nom'] ?>" required>
                                <label for="nom">Nom</label>
                            </div>
                            <div class="form-group">
                                <input type="text" id="prenom" name="prenom" value="<?php echo $cl['prenom'] ?>" required>
                                <label for="prenom">Prenom</label>
                            </div>
                        </div>
                        <div class="nom">
                            <div class="form-group">
                                <input type="text" id="adr" name="adr" value="<?php echo $cl['adresse'] ?>" required>
                                <label for="adr">Adresse</label>
                            </div>
                            <div class="form-group">
                                <input type="text" id="tel" name="tel" value="<?php echo $cl['telephone'] ?>" required>
                                <label for="tel">Telephone</label>
                            </div>
                        </div>
            
                        <div class="form-group">
                            <input type="email" id="email" name="email" value="<?php echo $cl['email'] ?>" required>
                            <label for="email">Adresse Email</label>
                        </div>
            
                        <div class="nom">
                            <div class="form-group">
                                <input type="password" id="password" name="mdp" value="<?php echo $cl['mot_de_passe'] ?>" required>
