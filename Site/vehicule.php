...
if(isset($_POST["search"]) && (!empty($_POST["type"]) || !empty($_POST["marque"]) || !empty($_POST['min']) || !empty($_POST['max']))){
    $type = $_POST['type'];
    $marque = $_POST['marque'];
    $min = $_POST['min'];
    $max = $_POST['max'];

    $sql = "SELECT * FROM vehicules WHERE statut = 'disponible' AND type LIKE '%$type%' 
    OR marque LIKE '%$marque%'  AND prix_jour BETWEEN :min AND :max";
    $req = $conn->prepare($sql);
    $req->bindValue(':min', (float)$min, PDO::PARAM_STR);
    $req->bindValue(':max', (float)$max, PDO::PARAM_STR);
    $req->execute();
    ...
    <header class="header">
        <div class="container">
            <div class="header-content">
                <!-- <div class="container"> -->
                    <div class="logo">
                        <a href="index.php"><img class="logoImg" src="../images/footerlogo-removebg-preview.png" alt=""></a>
                    </div>
                    ...
                    <ul class="menu">
                        ...
                        <div class="user-menu-container">
                            ...
                            <ul class="dropdown-menu" id="dropdownMenu" style="z-index:2000;">
                ...
                <div class="section-search">
                    <form action=" " method="POST">
                        <div class="champ">
                            ...
                            <input type="text" name="type" placeholder="SUV, Truck...">
                        </div>

                        <div class="champ">
                            <label for="">MARQUE</label>
                            <div class="span-absolute">
                                <input type="text" name="marque" placeholder="Citoen, Peugeot...">
                            </div>
                        </div>
                        ...
                        <div class="champ">
                            ...
                            <div class="span-absolute">
                                <input type="text" name="min" placeholder="15 000">
                                <span>FCFA</span>
                            </div>
                        </div>
                        <div class="champ">
                            ...
                            <div class="span-absolute">
                                <input type="text" name="max" placeholder="30 000">
                                <span>FCFA</span>
                            </div>
                        </div>
                    ...
                    <div class="search-grid">
                        <?php foreach($vehicules as $vehicule) {
                            $image_data = $vehicule['image_data'];
                        ...
                        <div class="card">
                            ...
                            <div class="card-present">
                                <div class="mrk">
                                    <span><?php echo $vehicule['marque'] ?></span>
                                    <span><?php echo $vehicule['type'] ?></span>
                                </div>
                                <p style="color:var(--text-muted);"><?php echo $vehicule['description'] ?></p>

                                <div class="reservation">
                                    <p>FCFA <?php echo $vehicule['prix_jour'] ?></p>
                                    <a href="demande.php?id=<?php echo $vehicule['id']?>">Rent Now</a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
