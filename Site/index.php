...
if(isset($_POST["search"]) && !empty($_POST["type"]) && !empty($_POST["marque"])){
    $type = $_POST['type'];
    $mark = $_POST['marque'];
    $dp = $_POST['dp'];
    $dr = $_POST['dr'];

    $sql = "SELECT * FROM vehicules WHERE statut = 'disponible' AND type = :type 
    OR marque = :marque";
    $req = $conn->prepare($sql);
    $req->bindParam(':type', $type);
    $req->bindParam(':marque', $mark);
    $req->execute();
...
<body>
    ...
    <main class="main">
        <div class="jumbo">
            <div class="container">
                <div class="jumbo-content" style="margin-top: 20px;">
                    <div class="title-section">
                        <h1>ONYX DRIVE</h1>
                        <p>Le prestige ne se possède pas, il se conduit. Bienvenue chez <span>Onyx Drive</span>, où chaque trajet devient une signature.</p>
                        
                        <a href="vehicule.php" class="btn-primary">Réserver maintenant</a>
                    </div>

                    <!-- <form action="" method="post">
                        <div class="champ">
                            <label for="">Marque</label>
                            <input type="text" name="marque" placeholder="Mercedes, peugeot...">
                        </div>
                        <div class="champ">
                            <label for="">Type</label>
                            <input type="text" name="type" placeholder="SUV...">
                        </div>
                        <div class="champ">
                            <label for="">Date de prise</label>
                            <input type="date" name="dp" placeholder="Date de prise">
                        </div>
                        <div class="champ">
                            <label for="">Date de retour</label>
                            <input type="date" name="dr" placeholder="Date de retour">
                        </div>
        ...
        <section class="services">
            <div class="container">
                <div class="services-content">
                    <div class="title">
                        <h2>Why Choose Us</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Delectus dolore neque fugiat iste iusto tempore.</p>
                    </div>
                    <div class="service-grid">
                        <div class="item">
                            ...
                            <div class="description">
                                <h3>Tarifs tranparents</h3>
                                <p>Lorem ipsum dolor sit amet elit. Libero similique voluptate rerum nesciunt numquam id labore necessitatibus facere quis provident!</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="img">
                            ...
                            <div class="description">
                                <h3>Vehicules recents</h3>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero similique voluptate rerum nesciunt ore necessitatibus facere quis provident!</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="img">
                            ...
                            <div class="description">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit.unt numquam id labore necessitatibus facere quis provident!</p>
                            </div>
                        </div>
                        <div class="item">
                            <div class="img">
                            ...
                            <div class="description">
                                ...
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Libero similique voluptate rerum nesciunt numquam id labore necessitatibus facere quis provident!</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="voitures-content">
                    ...
                    <div class="voiture-grid">
                        <?php $i = 0; foreach($vehicules as $veh) {
                        ...
                        <div class="voiture-item">
                            ...
                            <div class="details">
                                <h3 style="text-align: left;"><?php echo $veh["modele"]." ".$veh["type"] ?></h3>

                                <div class="desc">
                                    <p style="text-align:left; color: var(--text-muted);"><?php echo $veh["description"] ?></p>
                                </div>

                                <hr>

                                <div class="price">
                                    <p>FCFA <?php echo $veh["prix_jour"] ?>/j</p>
                                    <a href="demande.php?id=<?php echo $veh['id'] ?>">Rent now</a>
                                </div>
                            </div>
                        </div>
                        <?php } ?>
        ...
        <section class="processus">
            <div class="container">
                <div class="processus content">
                    <div class="title">
                        <h2>How it works</h2>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ducimus, laudantium laboriosam alias consequuntur placeat quo!</p>
                    </div>

                    <div class="processus-grid">
                        <div class="processus-item">
                            <h4>1. Choississez votre véhicule</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, sit!</p>
                        </div>
                        <div class="processus-item">
                            <h4>2. Réservez en ligne</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, sit!</p>
                        </div>
                        <div class="processus-item">
                            <h4>3. Recupérer le véhicule</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, sit!</p>
                        </div>
                        <div class="processus-item">
                            <h4>4. Profiter de votre trajet</h4>
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Cupiditate, sit!</p>
                        </div>
                    </div>
                </div>
        ...
        <section class="hero">
            <div class="container">
                <div class="hero-content">
                    <h1>MAÎTRISEZ LA TRAJECTOIRE.</h1>
                    <p>Découvrez une expérience de location où la pureté du design rencontre la fluidité du mouvement. Bienvenue chez Onyx Drive.</p>
                    <a href="vehicule.php">Reserver maintenant</a>
                </div>
            </div>
        </section>
    </main>
    ...
    <script>       
        $('.voiture-grid').slick({
            ...
            slidesToScroll: 1,
            dots: true,
            prevArrow: '<div class="slick-prev"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M15 6C15 6 9.00001 10.4189 9 12C8.99999 13.5812 15 18 15 18" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 6C15 6 9.00001 10.4189 9 12C8.99999 13.5812 15 18 15 18" stroke="white" stroke-opacity="0.2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M15 6C15 6 9.00001 10.4189 9 12C8.99999 13.5812 15 18 15 18" stroke="white" stroke-opacity="0.2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>',
            nextArrow: '<div class="slick-next"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9.00005 6C9.00005 6 15 10.4189 15 12C15 13.5812 9 18 9 18" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.00005 6C9.00005 6 15 10.4189 15 12C15 13.5812 9 18 9 18" stroke="white" stroke-opacity="0.2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M9.00005 6C9.00005 6 15 10.4189 15 12C15 13.5812 9 18 9 18" stroke="white" stroke-opacity="0.2" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg></div>'
        });
